...
{
    public partial class attachDocs : Form
    {
		/// <summary>
		...
		{
			this.Hide();
			var temp = new analisResult(currentEventID, listOfAttachedFi,listOfAll);
		...
		{
			var temp = db.GetRows("event_documents", "document_code", "event_id=" + DBUtil.ValidateForSQL(currentEventID));
